...
export async function getServerSideProps(context) {
    ...
    try {
        ...
        featuredData = await axios.get(`https://api.themoviedb.org/3/discover/${context.query.mediaType}?api_key=f7e5193a85a5af98ed826e30d2e8a2c5&language=en-US&sort_by=popularity.desc&primary_release_year=2021`);
    } catch (error) {
        console.log("error");
        console.log(error);
    }
